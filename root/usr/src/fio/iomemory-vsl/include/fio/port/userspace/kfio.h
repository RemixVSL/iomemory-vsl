...
#ifndef __FIO_PORT_USERSPACE_KFIO_H__
#define __FIO_PORT_USERSPACE_KFIO_H__
...
#include <fio/port/userspace/div64.h>
...
extern int kfio_register_CSR_simulator(struct iodrive_channel *chan, simulated_register_write write, simulated_register_read read, void *context);
extern int kfio_unregister_CSR_simulator(struct iodrive_channel *chan);
extern void nandsim_dump_state(void *fusion_nand_device);

extern int g_terminate_simulator; // set non-zero to terminate the userspace simulator.

#endif /* __FIO_PORT_USERSPACE_KFIO_H__ */
