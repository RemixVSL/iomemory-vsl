...
#ifndef __FUSION_USERSPACE_KTYPES_H__
#define __FUSION_USERSPACE_KTYPES_H__

#ifndef __FIO_PORT_KTYPES_H__
#error Do not include this file directly - instead include <fio/port/ktypes.h>
#endif

#include <fio/port/userspace/kassert.h>
...
#include <fio/port/userspace/kfile.h>
...
#if defined(__x86_64__) || defined(__PPC64__) || defined(__mips64) || (defined(__sparc__) && defined(_LP64) )
#define FIO_WORD_SIZE 8
#define FIO_BITS_PER_LONG 64
#elif defined(__i386__) || defined(__PPC__) || (defined(__sparc__) && !defined(_LP64))
...
/* OS X userspace debug requires 200 bytes */
    DECLARE_RESERVE(200); // linux 2.6.29 kernel with mutex debugging on: 152 bytes...
};
...
// implementations.
/* OS X debug userspace requires 208 bytes */
    DECLARE_RESERVE(208);
...
# define kfio_barrier()          __sync_synchronize() // GCC 4.1+ builtin.
#else
...
/* The userspace driver port uses the ioctl kfio backend. */
