...
char * fio_find_char(char *param_1,char param_2);
...
ulong kfio_info_create_dir_root(void);
...
int fio_attach(long *param_1,int param_2,uint param_3);
...
int fio_auto_attach(long param_1);
void fio_auto_attach_wait(void);
int fio_detach_devices(void);
...
undefined8 fio_set_write_mode(long param_1,int param_2,char *param_3,char *param_4);
ulong fio_ioctl(long *param_1,uint param_2,undefined4 *param_3,char *param_4);
undefined4 fio_get_write_mode(long param_1);
undefined4 fio_get_write_mode_ext(long param_1);
...
undefined8 fusion_thread_destager(long *param_1);
...
undefined8 fusion_start_thread_destager(long **param_1);
...
void fio_open_or_release(long param_1,char param_2);
...
undefined8 fusion_thread_groom(ushort *param_1);
...
ulong fusion_start_thread_groom(long *param_1,int param_2);
...
undefined8 fusion_thread_gselect(long **param_1);
undefined8 fusion_start_thread_gselect(long *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5,undefined8 param_6);
...
void kfio_info_create_dir_fio(void);
void kfio_info_remove_node_fio(void);
...
ulong kfio_info_create_dir_groomer(long param_1);
...
int fio_nv_data_read(long *param_1,long param_2,ushort param_3,char **param_4,char param_5);
...
ulong kfio_info_create_dir_vsu(long param_1);
...
undefined8 fusion_start_thread_worker(long *param_1);
...
undefined fio_get_char(undefined *param_1);
bool fio_px2_data_str_not_empty(long param_1);
undefined fio_px2_data_get_int1(long param_1);
undefined2 fio_px2_data_get_int2(long param_1);
undefined4 fio_px2_data_get_int4(long param_1);
long fio_px2_data_strcpy(long param_1,long param_2,long param_3);
undefined fio_px2_data_memcpy(long param_1,undefined8 param_2,ulong param_3);
...
int fio_nv_data_verify(long param_1,undefined8 param_2,long param_3);
undefined8 fio_nv_data_init(long param_1,int param_2);
...
void fio_set_channel_failed(long param_1);
...
undefined8 fusion_thread_worker(long param_1,long param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5,undefined8 param_6);
...
int fio_nv_data_upgrade(long *param_1,undefined8 *param_2);
...
ulong kfio_info_create_dir_scanner(long param_1);
...
undefined8 fusion_start_thread_scan(long *param_1);
